...
#output a preprocess r data file for the low res data (1 gps point/10 mins) from 9am-6pm
library(lubridate)
...
save(list=c('xs','ys','ts'), file = paste0(outdir,'galaxy_xy_10min_9am_level0.RData'))
save(list=c('lats','lons','ts'), file = paste0(outdir,'galaxy_latlon_10min_9am_level0.RData'))  
