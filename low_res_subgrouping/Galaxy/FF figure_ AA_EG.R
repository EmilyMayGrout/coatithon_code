...
#this script is editing the original code for the plot
# 2023-10-24
...
df <- read.csv("C:/Users/egrout/Dropbox/coatithon/processed/2022/galaxy/060122_gal_subgrouping.csv")
str(df)
...
#removing times before 14:00 UTC for 0501022
#df <- df[df$time > 966,]

#removing times before 14:30 UTC for 0501022
df <- df[df$time < 1070,]
