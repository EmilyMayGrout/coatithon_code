...
outdir <- "C:/Users/egrout/Dropbox/coatithon/coatithon_code/FLICA/"
...
#rm(list=ls())
#load("C:/Users/egrout/Dropbox/coatithon/processed/2022/galaxy/galaxy_xy_highres_array_flica.RData")
